...
class DiagnosticSylvicoleRepositoryImpl(
    private val dao: DiagnosticSylvicoleDao,
    private val metadataService: MetadataService,
) : DiagnosticSylvicoleRepository {
    ...
    override suspend fun insert(diagnostic: DiagnosticSylvicole) =
